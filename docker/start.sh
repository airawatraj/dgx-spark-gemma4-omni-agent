...
SPECULATIVE_CONFIG="${SPECULATIVE_CONFIG:-{\"method\":\"mtp\",\"model\":\"${SPECULATIVE_MODEL_ID}\",\"num_speculative_tokens\":${NUM_SPECULATIVE_TOKENS}}}"
...
echo "  Draft model:     $SPECULATIVE_MODEL_ID"
echo
